...
node tests/run.mjs              # 54 tests, zero deps. Expect 54/54.
...
src/domain/    pure, no DOM, this is where the tests live
               ...
               foods.js    FOOD_DB, portionPrior, usualMeals, oil arithmetic
...
Deadbands are unit-aware (`bands()` in engine.js) — imperial and metric are
separate tables, not a conversion.
...
- Portion priors need 3 corrections per food before they apply.
